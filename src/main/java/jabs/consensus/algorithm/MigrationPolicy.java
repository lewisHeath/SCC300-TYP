...
public interface MigrationPolicy {
    ...
    void migrateIfNecessary(EthereumAccount account, EthereumAccount receiver, EthereumAccount sender, Map<String, Integer> crossShardTransactionCount, boolean activate);
