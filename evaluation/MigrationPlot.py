...
df_without_migration = pd.read_csv('output/tenNodesSimulations/clientled/exponent1.2/seed1/Clientled-WithoutMigrations-8s10n800c.csv')
num_rows_without_migration = len(df_without_migration)

# Load the migration data
df_migration = pd.read_csv('output/tenNodesSimulations/clientled/exponent1.2/seed1/Clientled-Migrations-8s10n800c.csv')
